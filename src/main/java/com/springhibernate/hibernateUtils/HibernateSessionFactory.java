...
public final class HibernateSessionFactory
{
	 ...
	 */
	private static String CONFIG_FILE_LOCATION = "classpath:hibernate.cfg.xml";
	...
	static
	{
		try
		{
			...
			logger.info("Success Creating SessionFactory.");
		}
		catch (Exception e)
		{
	...
	{
		logger.info("init HibernateSessionFactory.");
	}
